...
<title>Data Batu Masuk</title>


<body>
    <h1 class="text-center mb-4">Edit Batu Masuk</h1>
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-8">
                <div class="card">
                    <div class="card-body">
                        {{-- <form method="POST" action={{ route('batumasuk.update', $item->id) }} enctype="multipart/form-data"> --}}
                        <form method="POST" action="{{ route('batumasuk.update', $item->id) }}" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
