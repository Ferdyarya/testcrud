...
<head>
    ...
    <title>Aplikasi Perbatuan</title>
    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="index3.html" class="brand-link">
                ...
                <span class="brand-text font-weight-light"><b>CV RPT</b></span>
            </a>
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="{{ route('mastercustomer.index')}}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Data Customer</p>
                                    </a>
                                </li>
                                ...
                                <li class="nav-item">
                                    <a href="{{ route('masterbatu.index')}}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Data Batu</p>
                                    </a>
                                </li>
