...
<body>
    <h1 class="text-center mb-4">Edit Master Data Customer</h1>
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-8">
                <div class="card">
                    <div class="card-body">
                        <form method="POST" action="{{ route('mastercustomer.update', $item->id) }}" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="form-group">
                                <label for="exampleInputEmail1">Nama Customer</label>
                                <input value="{{ $item->namacust }}" type="text" name="namacust" class="form-control"
                                    id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Masukan Customer"
                                    required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input value="{{ $item->no_telp }}" type="number" name="no_telp"
                                    class="form-control" id="exampleInputPassword1" placeholder="Masukan No Telpon"
                                    required>
                            </div>
                            <div class="form-group">
