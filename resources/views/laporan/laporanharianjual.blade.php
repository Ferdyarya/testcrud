    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Laporan Harian Jual Batu</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="#">Dashboard</a></li>
                            <li class="breadcrumb-item active">Laporan Harian Jual batu</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no" /> --}}
        ...
        <div class="container">
            ...
            <div class=" mb-2">
                ...
                <form action="{{ route('laporanharianjual') }}" method="GET">
                    <div class="input-group">
                        ...
                        <div class="pt-4">
                            @if (!empty($filter))
                                <a href="{{ route('laporanharianjualpdf', $filter) }}" class="btn btn-danger">Export
                                    PDF</a>
                            @else
                                <a href="{{ route('laporanharianjualpdf', 'all') }}" class="btn btn-danger">Export PDF</a>
                            @endif
                        </div>
                ...
                <table class="table table-hover">
                    <thead>
                        <tr>
                            ...
                            <th class="px-6 py-6">Material</th>
                            <th class="px-6 py-6">Total Retase</th>
                            <th class="px-6 py-6">Total Retase KG</th>
                    ...
                    <tbody>
                        @php
                            $no = 1;
                        @endphp
                        @foreach ($laporanharianjual as $item)
                            <tr>
                                ...
                                <td class="px-6 py-6">{{ $item->retase }}</td>
                                <td class="px-6 py-6">{{ $item->tonase }}</td>
                                <td class="px-6 py-6">Rp. {{ number_format($item->harga) }}</td>
                                {{-- <td>
                                ...
                                <td class="px-6 py-2">
                                    @if ($item->status == 0)
                                        @if (Auth::user()->hakakses('Manager Operasional'))
