...
<body>
    ...
    <center>
        <h5 class="mt-4">Rekap Laporan Harian Jual</h5>
    </center>
        ...
        <tbody>
            ...
            @foreach ($laporanharianjual as $item)
                <tr>
                    ...
                    <td class="border textmid">{{ $item->retase }}</td>
                    <td class="border textmid">{{ $item->tonase }}</td>
                    <td class="border textmid">Rp. {{ number_format($item->harga) }}</td>
