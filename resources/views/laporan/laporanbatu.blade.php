    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Laporan Penjualan Batu</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="#">Dashboard</a></li>
                            <li class="breadcrumb-item active">Laporan Penjualan Batu</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no" /> --}}
        ...
        <div class="container">
            ...
            <div class=" mb-2">
                ...
                <form action="{{ route('laporanbatu') }}" method="GET">
                    <div class="input-group">
                        ...
                        <div class="pt-4">
                            @if (!empty($filter))
                                <a href="{{ route('laporanbatupdf', $filter) }}" class="btn btn-danger">Export PDF</a>
                            @else
                                <a href="{{ route('laporanbatupdf', 'all') }}" class="btn btn-danger">Export PDF</a>
                            @endif
                        </div>
